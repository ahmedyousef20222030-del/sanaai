...
import { SYSTEM_PAGES, findPageByPath, type PageAction, type SystemPage } from '@/lib/pages-config'
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // ── القائمة الجانبية: dashboard دايمًا ظاهرة، settings للـ owner بس، الباقي حسب can_view ──
  const visibleNavItems = useMemo(() => {
    const sections = new Map<string, SystemPage[]>()
